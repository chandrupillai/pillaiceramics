...
@section('title', 'Add Tile Product')
...
<div class="container-fluid px-2 px-sm-3 py-3">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2 mb-3 mb-md-4">
        <div>
            <h4 class="fw-bold mb-1 fs-5 fs-md-4">Add Tile Product</h4>
            <p class="text-muted fs-7 mb-0">Create a new tile product entry with inventory and pricing specs.</p>
        </div>
        <div>
    ...
    <form action="{{ route('admin.tile-products.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body pt-0">
                        <div class="row g-3">
                            <div class="col-12 col-md-8">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-md-sm fs-6 fs-md-7 @error('product_name') is-invalid @enderror" id="product_name" name="product_name" value="{{ old('product_name') }}" placeholder="e.g. Marble Finish White Porcelain Tile" required>
                                @error('product_name')
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-md-sm fs-6 fs-md-7 text-uppercase @error('sku') is-invalid @enderror" id="sku" name="sku" value="{{ old('sku') }}" placeholder="e.g. TILE-WHT-6060" required>
                                @error('sku')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control fs-6 fs-md-7 @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Enter product details, finish specs, or usage instructions...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-sm-6 col-md-4">
                                ...
                                <select class="form-select form-select-lg form-select-md-sm fs-6 fs-md-7 @error('tile_category_id') is-invalid @enderror" id="tile_category_id" name="tile_category_id" required>
                                    <option value="" disabled {{ old('tile_category_id') ? '' : 'selected' }}>Select Category</option>
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('tile_category_id') == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                ...
                                <select class="form-select form-select-lg form-select-md-sm fs-6 fs-md-7 @error('tile_type_id') is-invalid @enderror" id="tile_type_id" name="tile_type_id" required>
                                    <option value="" disabled {{ old('tile_type_id') ? '' : 'selected' }}>Select Type</option>
                                    @foreach($types as $type)
                                        <option value="{{ $type->id }}" {{ old('tile_type_id') == $type->id ? 'selected' : '' }}>
                                            {{ $type->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-sm-12 col-md-4">
                                ...
                                <select class="form-select form-select-lg form-select-md-sm fs-6 fs-md-7 @error('tile_size_id') is-invalid @enderror" id="tile_size_id" name="tile_size_id" required>
                                    <option value="" disabled {{ old('tile_size_id') ? '' : 'selected' }}>Select Size</option>
                                    @foreach($sizes as $size)
                                        <option value="{{ $size->id }}" {{ old('tile_size_id') == $size->id ? 'selected' : '' }}>
                                            {{ $size->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control form-control-lg form-control-md-sm fs-6 fs-md-7 @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price') }}" placeholder="0.00" required>
                                </div>
                                @error('price')
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="number" class="form-control form-control-lg form-control-md-sm fs-6 fs-md-7 @error('stock_quantity') is-invalid @enderror" id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity', 0) }}" min="0" required>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-md-sm fs-6 fs-md-7 @error('box_coverage_sqft') is-invalid @enderror" id="box_coverage_sqft" name="box_coverage_sqft" value="{{ old('box_coverage_sqft') }}" placeholder="e.g. 15.5">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="number" class="form-control form-control-lg form-control-md-sm fs-6 fs-md-7 @error('pieces_per_box') is-invalid @enderror" id="pieces_per_box" name="pieces_per_box" value="{{ old('pieces_per_box') }}" min="1" placeholder="e.g. 4">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-3 mb-3 mb-md-4">
                    ...
                    <div class="card-body pt-0 text-center">
                        ...
                        <small class="text-muted d-block mt-2 fs-8">JPG, PNG, WEBP (Max 2MB)</small>
                        @error('image')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-lg form-select-md-sm fs-6 fs-md-7 @error('godown_id') is-invalid @enderror" id="godown_id" name="godown_id">
                                ...
                                @foreach($godowns as $godown)
                                    <option value="{{ $godown->id }}" {{ old('godown_id') == $godown->id ? 'selected' : '' }}>
                                        {{ $godown->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="card border-0 shadow-sm rounded-3 mb-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="form-check form-switch p-0 d-flex justify-content-between align-items-center">
                            ...
                            <input class="form-check-input ms-0" type="checkbox" role="switch" id="is_active" name="is_active" value="1" style="width: 2.5em; height: 1.25em;" {{ old('is_active', '1') ? 'checked' : '' }}>
                        </div>
